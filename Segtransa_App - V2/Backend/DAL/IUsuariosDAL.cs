   ...
   public interface IUsuariosDAL
    {
       ...
       #region Métodos para retornar datos y listas de lo SP
        ...
        /// </summary>
        List<spUsuariosRetornaListaEmpleados_Result> retornaListaEmpleados(int? pIdEmpleado);


        /// <summary>
        /// Método para retornar Empleado por Id
        /// </summary>
        spUsuariosRetornaListaEmpleados_Result retornaEmpleadoId(int pIdEmpleado);
        ...
        /// </summary>
        bool InsertaUsuario(string pNombre, string pApellido, int pEstadoUsuario, int pRolUsuario, int pCedula, string pContrasena,
       string pTelefono, string pCorreo, string pDireccion, DateTime pFechaCreacion);
        ...
        /// </summary>
        bool ModificaUsuario(int IdUsuario, string pNombre, string pApellido, int pEstadoUsuario, int pRolUsuario, int pCedula, string pContrasena,
       string pTelefono, string pCorreo, string pDireccion, DateTime pFechaCreacion);
