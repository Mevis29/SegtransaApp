...
namespace Backend.DAL
{
    public class UsuariosImplDAL : IUsuariosDAL
    {
        ...
        DBContext modeloBD = new DBContext();
        ...
        public spUsuariosRetornaDatosLogin_Result retornaDatosLogin(string pCorreo, string pContrasena)
        {
            ...
            resultado = this.modeloBD.spUsuariosRetornaDatosLogin(pCorreo, pContrasena).FirstOrDefault();
        ...
        public bool actualizaDatosLogin(int pIdUsuario)
        {
            ...
            try
            {
                int registrosAfectados = modeloBD.spUsuariosActualizaUltLogin(pIdUsuario);
        ...
        public spUsuariosRetornaDatosId_Result retornaUsuarioId(int pIdUsuario)
        {
            ...
            resultado = this.modeloBD.spUsuariosRetornaDatosId(pIdUsuario).FirstOrDefault();
        ...
        public List<spUsuariosRetornaLista_Result> retornaListaUsuarios(string pCedula, string pNombre, string pCorreo)
        {
            ...
            resultado = this.modeloBD.spUsuariosRetornaLista(pCedula, pNombre, pCorreo).ToList();
        ...
        public List<spUsuariosRetornaListaId_Result> retornaListaUsuarioId(int pIdUsuario)
        {
            ...
            resultado = this.modeloBD.spUsuariosRetornaListaId(pIdUsuario).ToList();
        ...
        /// </summary>
        public List<spUsuariosRetornaListaEmpleados_Result> retornaListaEmpleados(int? pIdEmpleado)
        {
            List<spUsuariosRetornaListaEmpleados_Result> resultado = new List<spUsuariosRetornaListaEmpleados_Result>();

            resultado = this.modeloBD.spUsuariosRetornaListaEmpleados(pIdEmpleado).ToList();
        ...
        /// </summary>
        public spUsuariosRetornaListaEmpleados_Result retornaEmpleadoId(int pIdEmpleado)
        {
            spUsuariosRetornaListaEmpleados_Result resultado = new spUsuariosRetornaListaEmpleados_Result();

            resultado = this.modeloBD.spUsuariosRetornaListaEmpleados(pIdEmpleado).FirstOrDefault();
        ...
        public List<spEstadoUsuariosRetornaLista_Result> retornaListaEstadosUsuario()
        {
            ...
            resultado = this.modeloBD.spEstadoUsuariosRetornaLista().ToList();
        ...
        public List<spRolesRetornaLista_Result> retornaListaRolesUsuario()
        {
            ...
            resultado = this.modeloBD.spRolesRetornaLista().ToList();
        ...
        /// </summary>
        public bool InsertaUsuario(string pNombre, string pApellido, int pEstadoUsuario, int pRolUsuario, int pCedula, string pContrasena,
       string pTelefono, string pCorreo, string pDireccion, DateTime pFechaCreacion)
        {
            bool resultado = false;
            try
            {
                int registrosAfectados = this.modeloBD.spUsuariosInsertaDatos(pNombre, pApellido, pEstadoUsuario, pRolUsuario, pCedula, pContrasena,
       pTelefono, pCorreo, pDireccion, pFechaCreacion);
        ...
        /// </summary>
        public bool ModificaUsuario(int IdUsuario, string pNombre, string pApellido, int pEstadoUsuario, int pRolUsuario, int pCedula, string pContrasena,
       string pTelefono, string pCorreo, string pDireccion, DateTime pFechaCreacion)
        {
            bool resultado = false;
            try
            {
                int registrosAfectados = this.modeloBD.spUsuariosModificaDatos(IdUsuario, pNombre, pApellido, pEstadoUsuario, pRolUsuario, pCedula, pContrasena,
       pTelefono, pCorreo, pDireccion, pFechaCreacion);
        ...
        public bool EliminaUsuario(int IdUsuario)
        {
            ...
            try
            {
                int registrosAfectados = modeloBD.spUsuariosEliminaDatos(IdUsuario);
