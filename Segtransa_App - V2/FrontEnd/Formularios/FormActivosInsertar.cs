...
namespace FrontEnd
{
    public partial class FormActivosAgregar : Form
    {
        ...
        public FormActivosAgregar(Form prevForm)
        {
        ...
        private void cargaCombo()
        {
            ...
            List<Proveedore> proveedor = proveedoresDAL.GetProveedores();

            cmbBoxStt.DisplayMember = "nombreEstado";
            cmbBoxStt.ValueMember = "idEstadoActivo";
            List<EstadoActivo> estadosActivos = estadosDAL.GetEstadoActivos();
